     ...
     1px solid #bbb; color:black;padding:15px;">
                ...
                <?php
                    ...
                    foreach ($all_categories as $cat) {
                        ...
                        if ($categories_cnt != 0) {
                            echo "<ul class='category checkboxcategory'><li ><input type='checkbox' id='$category_id' value='$category_id' class='category'/><label>$cat->name</label></ul></li>";
                            $sub_cats = get_categories($args2);
                            if ($sub_cats) {
                                echo "<ul class='category sub_cats'>";
                                foreach ($sub_cats as $sub_category) {
                                    $sub_category_id = $sub_category->term_taxonomy_id;
                                    echo "<li ><input type='checkbox' name='' id='$sub_category_id' value='$sub_category_id' class='category' /><label>$sub_category->cat_name</label></li>";
                                    $args = array(
                                        'post_type' => 'product',
