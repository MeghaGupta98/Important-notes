...
function my_theme_enqueue_styles() { 
	...
	wp_enqueue_style( 'parent-style-1', get_template_directory_uri() . '/slider-files/css/slick.css' );
	wp_enqueue_style( 'parent-style-2', get_template_directory_uri() . '/slider-files/css/slick-theme.min.css' );
	wp_enqueue_style( 'parent-style-3', get_template_directory_uri() . '/slider-files/css/slick-style.css' );

	wp_enqueue_script('parent-script', get_template_directory_uri() . '/slider-files/js/jquery.min.js');
	wp_enqueue_script('parent-script-1', get_template_directory_uri() . '/slider-files/js/slick.js');
	wp_enqueue_script('parent-script-2', get_template_directory_uri() . '/slider-files/js/script.js');
	wp_enqueue_script('parent-script-3', get_template_directory_uri() . '/slider-files/js/slick.min.js');
}
...
function productonsale() {
    ...
    $loop = new WP_Query( $args );
    $return_string = ""; 
  $content= '<div class="right_side_bar_home"><div class="product_card_row" id="list-row"><div class="wrapper">
				<div class="my-slider">';
	while ( $loop->have_posts() ) : $loop->the_post(); 
