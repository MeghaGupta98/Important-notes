                        ...
                        if ($categories_cnt != 0) {
                            ...
                            if ($sub_cats) {
                                ...
                                foreach ($sub_cats as $sub_category) {
                                    ...
                                    echo "<li><input type='checkbox' name='' id='$sub_category_id' value='$sub_category_id' class='category' style='width: 12px; opacity: 10;'/>$sub_category->cat_name</li>";
                                    $args = array(
                                        'post_type' => 'product',
                            ...
                            echo "<ul class='category'><li><input type='checkbox' id='$category_id' value='$category_id' class='category' style='width: 12px; opacity: 10;'/><h4>$cat->name</h4></ul></li>";
                    ?>
                    <?php wp_reset_query();
                        }
                    }
