...
class Mwb_Bookings_For_Woocommerce_Admin {
	...
	public function mbfw_add_availability_settings_page( $mbfw_availability_settings ) {
		$mbfw_availability_settings = array(
			...
			array(
				'title'       => __( 'Holiday day list', 'mwb-bookings-for-woocommerce' ),
				'id'          => 'mwb_mbfw_year_holidays',
				'name'        => 'mwb_mbfw_year_holidays',
				'class'       => 'mwb_mbfw_year_holidays',
				'value'       => get_option( 'mwb_mbfw_year_holidays' ),
				'type'        => 'textarea',
				'placeholder'        => 'Please enter all dates for holidays ex. 01-16-2022(mm-dd-yy).',
				'description' => __( 'Please enter all dates for holidays ex. 01-19-2022(mm-dd-yy).', 'mwb-bookings-for-woocommerce' ),
			),
			array(
				'title'       => __( 'Off Time', 'mwb-bookings-for-woocommerce' ),
				'id'          => 'mwb_mbfw_year_offtime',
				'name'        => 'mwb_mbfw_year_offtime',
				'class'       => 'mwb_mbfw_year_offtime',
				'value'       => get_option( 'mwb_mbfw_year_offtime' ),
				'type'        => 'textarea',
				'placeholder'        => 'Please enter all dates for Off Time ex. 01-11-2022(mm-dd-yy).',
				'description' => __( 'Please enter all dates for Off Time ex. 01-12-2022(mm-dd-yy).', 'mwb-bookings-for-woocommerce' ),
			),
		);
