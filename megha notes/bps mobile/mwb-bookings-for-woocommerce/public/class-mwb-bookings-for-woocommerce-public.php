...
class Mwb_Bookings_For_Woocommerce_Public {
	...
	public function mwb_mbfw_show_date_time_selector_on_single_product_page( $product_id, $product ) {
		...
		$start_time = get_option( 'mwb_mbfw_daily_start_time' );
		$end_time   = get_option( 'mwb_mbfw_daily_end_time' );
		$offtimes   = get_option( 'mwb_mbfw_year_offtime' );
		$holidays   = get_option( 'mwb_mbfw_year_holidays' );
		...
		if ( $class ) {
			...
			<div class="mbfw-date-picker-section__wrapper">
				<div class="mbfw-date-picker-section">
					...
					<input type="text" data-stime="<?php echo $start_time; ?>" data-etime="<?php echo $end_time; ?>" name="mwb_mbfw_booking_from_time" id="mwb-mbfw-booking-from-time" class="<?php echo esc_attr( $class ); ?>" autocomplete="off" placeholder="<?php echo esc_attr( $label1 ); ?>" required />
				</div>
				<div class="mbfw-date-picker-section">
					<label for="mwb-mbfw-booking-to-time"><?php esc_html_e( 'To', 'mwb-bookings-for-woocommerce' ); ?></label>
					<input type="text" name="mwb_mbfw_booking_to_time" id="mwb-mbfw-booking-to-time" class="<?php echo esc_attr( $class ); ?>" autocomplete="off" placeholder="<?php echo esc_attr( $label2 ); ?>" required />
					<input type="hidden" name="offtimes" id="offtimes" value="<?php echo $offtimes; ?>">
					<input type="hidden" name="holidays" id="holidays" value="<?php echo $holidays; ?>">
				</div>
			</div>
			<?php
		}
